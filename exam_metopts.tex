...
\begin{document}
	...
	\begin{itemize}[$\diamond$]
		\item Если оптимальное значение функции в этой задаче **не равно** $0$, то допустимое множество исходной задачи пусто.
		\item Если оптимальное значение функции в этой задаче **равно** $0$, то $y^* = 0$ и $x_0 = z^*$.
	\end{itemize}
	\subsection{М-метод}
